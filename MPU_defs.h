...
#define MPU6050_MEMORY_BANK_SIZE	256
#define MPU6050_DMP_CODE_SIZE       1929    // dmpMemory[]
#define MPU6050_DMP_CONFIG_SIZE     192     // dmpConfig[]
#define MPU6050_DMP_UPDATES_SIZE    47      // dmpUpdates[]

const unsigned char dmpMemoryBank0[MPU6050_MEMORY_BANK_SIZE] PROGMEM = {
	// bank 0, 256 bytes
...
#define ACC_SENSITIVITY				(1.0f/8096.0f)

#define GYRO_SENSITIVITY_500		(1.0f/65.5f)
#define GYRO_SENSITIVITY_2000		(1.0f/16.4f)
